# [Andres's Conceptuliazing Python Home Lab]() Project
...
We want to keep def main() untoched therefore it provides what we need already which is printing a result when it receives "True" or "False"<br/>
